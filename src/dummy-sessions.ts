...
export const HOME = [
    {
        ...
        img: studentsImg,
        title: 'What we do',
        text: 'ReactMentoring is a platform for React developers to find mentors'+
    ...
    },
    {
        ...
        img: listImg,
        title: 'What we offer',
        text: 'We offer a variety of mentoring sessions, from one-on-one mentoring'+
        ...
        img: certificateImg,
        title: 'What you get',
        text: 'No matter if you are a beginner or an experienced React developer,'+
